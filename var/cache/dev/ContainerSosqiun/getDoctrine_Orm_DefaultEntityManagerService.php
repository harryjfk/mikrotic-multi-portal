...
$a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/QbaBit/LanguageBundle/Resources/config/doctrine') => 'QbaBit\\LanguageBundle\\Entity', ($this->targetDirs[3].'/src/QbaBit/SecurityBundle/Resources/config/doctrine') => 'QbaBit\\SecurityBundle\\Entity', ($this->targetDirs[3].'/src/QbaBit/NautaBundle/Resources/config/doctrine') => 'QbaBit\\NautaBundle\\Entity'));
$a->setGlobalBasename('mapping');

$b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/QbaBit/CoreBundle/Entity'))), 'QbaBit\\CoreBundle\\Entity');
$b->addDriver($a, 'QbaBit\\LanguageBundle\\Entity');
$b->addDriver($a, 'QbaBit\\SecurityBundle\\Entity');
$b->addDriver($a, 'QbaBit\\NautaBundle\\Entity');

$c = new \Doctrine\ORM\Configuration();
$c->setEntityNamespaces(array('QbaBitCoreBundle' => 'QbaBit\\CoreBundle\\Entity', 'QbaBitLanguageBundle' => 'QbaBit\\LanguageBundle\\Entity', 'QbaBitSecurityBundle' => 'QbaBit\\SecurityBundle\\Entity', 'QbaBitNautaBundle' => 'QbaBit\\NautaBundle\\Entity'));
