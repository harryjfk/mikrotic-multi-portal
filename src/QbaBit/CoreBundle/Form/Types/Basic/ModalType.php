...
class ModalType extends AccessBaseType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefault('height', 500);
        $resolver->setDefault('buttonText', '');
        $resolver->setDefault('buttonClass', 'btn');
        $resolver->setDefault('buttonStyles', '');
        $resolver->setDefault('caption', '');
        $resolver->setDefault('form_render', null);
    }
    ...
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        $view->vars['form_render'] = $options['form_render'];
        $view->vars['buttonClass']=  $options['buttonClass'];
        $view->vars['buttonStyles']=  $options['buttonStyles'];
        $view->vars['onClick']=  $options['onClick'];
